...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('company')){
		...
		$query = "SELECT employee_id,Source1,Destination1,Source2,Destination2 FROM employee WHERE (Source1  
		...
		while($query_row = mysql_fetch_array($query_run)){
			...
			echo "<font size='4'><a href='searchquick.php?id=$id'>$name and $name1<br /></a>"."</font>";
