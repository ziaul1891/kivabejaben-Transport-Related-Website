...
<head>
  <title>KivabeJaben-Logout</title>
...
<div id="user">
	...
	if($username && $userid){
		session_destroy();
		require ("connect.php");
		mysql_query("UPDATE users SET online='0' where id=$userid");			

		echo "<font color='#456'>You have been logged out. -- <a href='./index.php'><font color='red'>Home</font></a></font>";
